...
def calligraphie():
  ...
  goto(0,150)
  color("#ffd700")
  write("بوليطيك مطعم",move=False, align="center", font=("Old English Text MT", 40, "bold"))
  up()
  goto(0,100)
  write("Tajines Polytech", move=False, align="center", font=("Old English Text MT", 40, "bold"))
  goto(-270,80)
  seth(0)
  down()
  fd(40)
  ...
  fd(10)
  sety(70)
  write("Spécialités marocaines depuis 2005", move=True, align="left", font=("Old English Text MT", 20, "bold"))
  sety(80)
  fd(10)
  down()
  fd(40)
...
def jeu():
  ...
  while intention==True:
    ...
    seth(0)
    goto(500,260)
    write("Que la partie commence !", move=False, align="right", font=("Old English Text MT", 35, "normal"))
    ...
    while gagnant==0 : #Quand gagnant ==0 personne n'a gagné, quand ==1 c'est le joueur qui gagne, et quand ==2 l'ordi a gagné.
      ...
      end_fill()
      goto(500,260)
      write("C'est votre tour!", move=False, align="right", font=("Old English Text MT", 35, "normal"))
      joueur=joueurJoue(q)
      jouer(joueur,q)
      x=-400+decalage
      speed(10)
      ...
      if len(q)==0  : #Si il ne reste plus de ligne alors:
        ...
        end_fill()
        goto(500,260)
        write(["L'ordi a joué ... " ,ordi] , move=False, align="right", font=("Old English Text MT", 35, "normal"))
        jouer(ordi,q)
        x=-400+decalage
        speed(10)
